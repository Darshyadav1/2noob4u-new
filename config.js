module.exports = {
  OWNER_IDS: "785009535969394689", // Bot owner ID's
  PREFIX: "+", // Default prefix for the bot
  SUPPORT_SERVER: "https://discord.gg/5PzGGTHjfb", // Your bot support server
  PRESENCE: {
    ENABLED: true, // Whether or not the bot should update its status
    STATUS: "online", // The bot's status [online, idle, dnd, invisible]
    TYPE: "WATCHING", // Status type for the bot [PLAYING | LISTENING | WATCHING | COMPETING]
    MESSAGE: "+help | {members} members in {servers} servers", // Your bot status message
  },
  DASHBOARD: {
  ...
  ECONOMY: {
    ...
    MIN_BEG_AMOUNT: 1, // minimum coins to be received when beg command is used
  ...
  MUSIC: {
    ...
    NODES: [
      ...
      },
      {
        ...
        identifier: "lavalink.gaproknetwork.xyz",
        retryDelay: 5000,
        secure: false,
      },
      {
